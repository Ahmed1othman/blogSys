    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('admin.category.index')}}">SubCategory</a></li>
        ...
        <div class="card-body">
            ...
            <form class="forms-sample" action="{{route('admin.subcategory.store')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="subcategory_en"  placeholder="Enter arabic subcategory name ..">
                </div>

                <div class="form-group">
                    <label for="exampleInputUsername2">SubCategory Arabic</label>
                    <input type="text" class="form-control" name="subcategory_ar" placeholder="Enter arabic subcategory name .. ">
                </div>
