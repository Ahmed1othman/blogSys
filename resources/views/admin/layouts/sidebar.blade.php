    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="Posts">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="{{route('admin.post.add')}}"> Create Post </a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{route('admin.post.index')}}"> All Posts </a></li>
                </ul>
            </div>
        </li>
